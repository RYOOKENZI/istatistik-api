...
class DataInputKS(BaseModel):
    data: list[float]
    test_type: str  # "ks" veya "lilliefors" veya "auto"
...
# ==========================================
# 2. K-S VE LILLIEFORS TESTİ (BİRLEŞTİRİLMİŞ)
# ==========================================
...
async def perform_ks_lilliefors(input_data: DataInputKS):
    ...
    # Çünkü parametreleri veriden tahmin ettiğimiz için K-S testinin p-değeri hatalı çıkar.
